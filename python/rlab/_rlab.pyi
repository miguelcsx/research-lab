...
class NativeSimhashDedup:
    def __init__(self, field: str = "text", source_field: str = "source", exact_min_words: int = 6, source_exact_min_words: Mapping[str, int] | None = None, near_enabled: bool = True, near_min_words: int = 12, near_hamming_threshold: int = 3, near_max_bucket_size: int = 64) -> None: ...
    def apply(self, records: object, _ctx: object | None = None) -> list[object]: ...

class NativeDocumentAssembler:
    def __init__(self, text_field: str = "text", source_field: str = "source", origin_field: str = "origin", target_word_budget: int = 10_000_000, source_word_targets: Mapping[str, int] | None = None, min_document_words: int = 50, max_document_chars: int = 20_000, max_document_lines: int = 400) -> None: ...
