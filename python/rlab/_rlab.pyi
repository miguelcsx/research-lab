...
class ComponentSpec(Generic[_T]):
    ...
    @classmethod
    def empty(cls, reference: str) -> ComponentSpec[object]: ...
    @classmethod
    def from_value(cls, value: object) -> ComponentSpec[object]: ...
    @property
    def ref(self) -> str: ...
    @property
...
def component_spec_from_value(value: object) -> ComponentSpec[object]: ...
