...
pub enum Command {
    ...
    Open(commands::open::OpenCommand),
    ...
    T: Into<std::ffi::OsString> + Clone,
{
    ...
    match cli.command {
        ...
        Command::View(command) => commands::view::run(command, cli.root.as_deref(), cli.json),
        Command::Open(command) => commands::open::run(command, cli.root.as_deref(), cli.json),
        Command::Ui(command) => commands::ui::run(command, cli.root.as_deref(), cli.json),
        ...
        Command::Gc(command) => commands::gc::run(command, cli.root.as_deref(), cli.json),
